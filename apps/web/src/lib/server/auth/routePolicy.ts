...
export const SESSION_WEB_ROUTES = [
  ...
  "GET /api/web/document-drafts/[draftId]/source-file",
  ...
  "POST /api/web/document-drafts/[draftId]/field-analysis",
  ...
  "GET /api/web/document-drafts/[draftId]/field-agent-suggestions",
  "POST /api/web/document-drafts/[draftId]/field-agent-suggestions",
  "PATCH /api/web/document-drafts/[draftId]/field-agent-suggestions/[suggestionId]",
  "GET /api/web/document-drafts/[draftId]/profile-autofill",
  "PUT /api/web/document-drafts/[draftId]/profile-autofill",
  "POST /api/web/document-drafts/[draftId]/schedule-suggestions",
  "POST /api/web/chat",
