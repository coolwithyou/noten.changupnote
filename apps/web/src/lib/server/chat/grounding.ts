...
export function buildChatSystemPrompt(): string {
  return [
    ...
    "- 현재 사용자 메시지에 '[사용자가 문의한 입력 항목' 블록이 있으면 해당 지원서 필드의 작성 협업 모드입니다.",
    "- 작성 협업 모드에서는 사용자가 직접 제공한 사실과 확인된 회사 정보만으로 초안 작성·수정을 돕습니다. 지원서 문구 작성 자체를 이유로 거절하지 않습니다.",
    "- 안전한 초안에 필요한 사실이 부족하면 내용을 지어내지 말고 기간·수치·역할 등 필요한 사실을 질문합니다.",
    "",
    "[문서 취급 규칙 — 반드시 준수]",
