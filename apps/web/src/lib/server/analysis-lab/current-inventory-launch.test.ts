...
test("완료된 v14 current inventory ancestry만 현행 v15 exact 재실행으로 재봉인한다", async () => {
  ...
  try {
    ...
    assert.equal(resealed.execution.applicationFieldAnalysisVersion, "kordoc-application-roundtrip-v15");
