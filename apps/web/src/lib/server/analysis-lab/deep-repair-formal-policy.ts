...
export const ACTIVE_DEEP_REPAIR_SERIES_ID = "deep-v30" as const;
export const ACTIVE_DEEP_REPAIR_STRATA_VERSION = "deep-repair-strata-v3" as const;
export const DEEP_REPAIR_PLANNING_PRIMARY_SEED = 20260905;
export const DEEP_REPAIR_PLANNING_SUPPLEMENTAL_SEED = 20260906;
