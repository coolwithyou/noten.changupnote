...
- 대량 배치 명령(정본): `ANALYSIS_LAB_TIMEOUT_MS=900000 ANALYSIS_LAB_TRANSPORT=claude-cli ANALYSIS_LAB_MODEL=claude-opus-5 pnpm lab:batch -- --limit=30 --max-cost-usd=15` (명목 상한은 실지출이 아니라 폭주 가드 — 27건 규모면 $15 필요). 검수: `ANALYSIS_LAB_TRANSPORT=claude-cli pnpm lab:ai-review -- --model=claude-fable-5 ...`.
