...
export const DEEP_ANALYSIS_PROMPT_VERSION = "deep-analysis-v3" as const;
export const DEEP_ANALYSIS_MODEL_POLICY_VERSION = "deep-analysis-model-policy-v5" as const;
