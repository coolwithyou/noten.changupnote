...
export const DEEP_ANALYSIS_PROMPT_VERSION = "deep-analysis-v6" as const;
export const DEEP_ANALYSIS_MODEL_POLICY_VERSION = "deep-analysis-model-policy-v9" as const;
