...
> **역사 문서:** 이 문서는 2026-08-05 당시 Kordoc 선분석 구조를 설명한다. 신규 일반 경로는
> 2026-08-25부터 RHWP 실시간 편집과 verified authoring guide 구조로 전환됐다. 현재 운영은
> [`공고 딥분석과 RHWP 작성 가이드 운영 가이드`](./deep-analysis-and-rhwp-authoring-guide-operations.md)를 따른다.

> 기준일: 2026-08-05 (역사 스냅샷)
> 대상: 제품·운영·개발 담당자
