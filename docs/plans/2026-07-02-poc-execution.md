...
> - 🔄 **[신규 트랙] Apply Experience v2 — 이상적 지원서 작성 경험** (2026-07-09 계획 수립, 레드팀 v2 반영 · **2026-07-10 진행: P0~P2c 완료(커밋 a92c3d2·5b0afcc·bb4c2d9·aa964fa·4767389) — 미니멀 상세 + workspace(필드 컨펌·사다리·HWPX 합류) + 구 기능 이식·/preview 리다이렉트까지 Phase 2 번들 완성. 검수에서 결함 2건 발견·수정(suggested Unfilled 미보고, 파일명↔스토리지키 매칭). 다음: P3 채팅 코어**): 미니멀 공고 상세 + `/grants/[id]/workspace`(HWP 프리뷰·필드 컨펌 채움·그라운딩 채팅·필드 AI 설명) + 매칭 보강 채팅(게이트). 정본: `docs/plans/2026-07-09-apply-experience-v2.md`. **착수 문서: `docs/plans/2026-07-10-apply-experience-v2-handover.md` (트리거 문장 포함, Fable 오케스트레이션 + opus/sonnet 위임)**. ideal-flow 슬라이스 D·E·G 승계
