...
| D4 | **LLM의 자리는 3곳뿐**: ①공고 추출(현행) ②골든셋 사전 라벨 ③conditional 해소 보조(후순위 — 구체 설계: `docs/research/2026-07-13-매칭대화에이전트-설계.md`, 실행 미착수). | 그 외 위치에 LLM 삽입 |
...
| docs/research/2026-07-13-매칭대화에이전트-설계.md | D4-③ 매칭 대화 에이전트 구체 설계 — 설계 확정, 실행 미착수 (착수 시 본 문서 §5 개정 선행) |
