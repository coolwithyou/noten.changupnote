...
> **🟡 상태 (2026-07-04)**: 외부 대조(델타) **완료·판정 반영** — 전제 4건 유지, kordoc은 text parser 계층으로 재분류 (`docs/research/2026-07-04-gate2-layout-adapters-calibration.md`, 마스터 1장·17장 이력 기록). 구현 위임 발주.
>
