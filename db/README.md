...
6. `pnpm publish:dedup`
7. `pnpm match:states:refresh -- --write`
8. `pnpm db:doctor`
9. `pnpm smoke:db`
...
`pnpm smoke:db` assumes the demo user/company, sample K-Startup/BizInfo grants,
dedup links, and match_state rows have already been prepared.
